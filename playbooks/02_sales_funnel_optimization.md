...
| ------------------------------------------- | ------ | ---------------------------------- |
| Hotel has 20+ rooms                         | +20    | Higher revenue potential           |
| Located in Tier 1 city                      | +10    | Higher ADR, more OTA dependency    |
| Located in Tier 2/3 city                    | +5     | Growth market                      |
| Came from referral                          | +25    | Highest conversion historically    |
| Came from organic search                    | +15    | Active intent                      |
| Came from paid ad                           | +10    | Interest but lower intent          |
| Visited pricing page                        | +20    | Strong buying signal               |
| Requested demo                              | +30    | Highest intent                     |
| Opened 2+ emails                            | +10    | Engaged                            |
...
| 40–69 | 🟡 Warm        | Sales calls within 24 hours. Automated nurture + personal follow-up.   |
